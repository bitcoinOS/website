...
export default function Footer() {
  return (
    <footer className="flex flex-col pt-10 pb-6 px-[80px]">
      <div className="w-full py-16 px-20 flex justify-between items-center border-2 border-slate-200 rounded-3xl">
        <div>
          <Image className='' width={180} height={44} src="/bitcoinOS-logo.png" alt="" />
      ...
      <p className="mt-6 text-center text-xs text-slate-500">Copyright © 2024 bitcoinOS. All rights reserved.</p>
    </footer>
  )
};
